...
@AllArgsConstructor //자동으로 생성자를 만들어주는 롬복 기능
public class PagingUtil {
	private int maxNum;//전체 컨텐츠 갯수 저장 변수 
	private int pageNum;//현재 보이는 페이지의 번호 저장 변수
	private int listCnt; //한 페이지 당 보일 콘텐츠 갯수 저장 변수
	private int pageCnt;//보여질 페이지 번호 갯수 저장 변수
